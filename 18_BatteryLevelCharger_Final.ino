...
Serial.begin(9600);
  ...
  batVolts = map(batVolts,0,1023,0,9);
...
batLevel = map(batVolts, 0, 9, 0, 100);
WELCOME();
digitalWrite(relayPin, LOW);
...
batVolts = 2;
    ...
    batVolts = map(batLevel,0,100,0,9);
//    batVolts = batVolts + 1;
